    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/benjaminhoegh/markdown-flavor-comparison/tree/main/docs/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/benjaminhoegh/markdown-flavor-comparison/tree/main/blog/',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'markdown flavor comparison',
        logo: {
          alt: 'markdown flavor comparison Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
